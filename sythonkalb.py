    ...
    if sender.id == ownerhson_id:
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | 𝓡𝓓")
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | 𝓡𝓓")
